package com.kauamendes.projetocurso;
...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat4 = new Categoria(null,"Tapetes");
		...
		Cliente cli2 = new Cliente(null,"Kaua Mendes","kaua@gmail.com","36378912377",TipoCliente.PESSOAFISICA, be.encode("kaua123"));
