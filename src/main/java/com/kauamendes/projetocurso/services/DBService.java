...
import com.kauamendes.projetocurso.domain.Pagamento;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "kauamended80@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, be.encode("kaua123"));
		Cliente cli2 = new Cliente(null, "Ana Costa", "anacosta@gmail.com", "311131231", TipoCliente.PESSOAFISICA, be.encode("k"));
		cli2.addPerfil(Perfil.ADMIN);
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli2.getTelefones().addAll(Arrays.asList("423423424", "43423124"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "38220834", cli2, c2);
